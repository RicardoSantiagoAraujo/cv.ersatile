...
contentDict_full_en = {
    "example": Colors(
        # base colors
        colorPrimary=("HTML", "000F00"),
        colorSecondary=("rgb", "0,0,1"),
        ...
        colorIcon=("rgb", "1,0.25,0.25"),
        colorIconBg=("", "colorBg"),
        colorTableBorders=("rgb", "1,0.25,0.25"),
        colorTableFill=("rgb", "1,0.25,0.25"),
        colorSectionTitleBg=("rgb", "1,0.25,0.25"),
