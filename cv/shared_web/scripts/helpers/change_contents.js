 ...
 * @param config Website configuration object
 */
export function addMultipleSections(config) {
 ...
 * @param config Website configuration object
 */
export function addHeader(const_general, config) {
    var secEl = document.createElement("header");
 ...
 * @param config Website configuration object
 */
export function updateTitle(config) {
 ...
 * @param lang Language code to be set (e.g., "en", "fr", "de")
 */
export function setTextures(bg_texture, page_texture) {
...
//# sourceMappingURL=change_contents.js.map